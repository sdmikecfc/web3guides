/**
 * SEASON 5 · IRON SIEGE — WARHAWKS route (key "warhawks").
 ...
 * otherwise win over this game's copy and read "Start" instead of "Take off"
 * in every locale. Same wiring as tankbuster/holdline/descent.
 *
...
export default function WarhawksPage() {
  const a = dict(getLocale()).arcade;
  return (
    <Client
      strings={{
        intro: a.warhawks.intro,
        introDaily: a.warhawks.introDaily,
        arena: a.warhawks.arena,
        shell: {
          ...a.shell,
          startIdle: a.warhawks.startIdle,
          startAgain: a.warhawks.startAgain,
          scoreUnit: a.warhawks.scoreUnit,
          dailyResultNote: a.warhawks.dailyResultNote,
        },
      }}
    />
  );

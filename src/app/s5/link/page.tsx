/**
 * Season 5 /s5/link — connect a wallet-first commander to Discord.
 *
 ...
 * /s5/link, which did not exist. Every player who ran the command on launch day
...
export default function S5LinkPage() {
  return (
    <PageShell>
      <div style={{ width: "100%", maxWidth: 440, margin: "0 auto" }}>
        ...
        <p style={{ textAlign: "center", color: UI.muted, fontSize: 15, margin: "0 0 28px" }}>
          One commander, one wallet, one Discord. Connect them so <b>/siege me</b> knows you.
        </p>
        <LinkForm />
      </div>
    </PageShell>

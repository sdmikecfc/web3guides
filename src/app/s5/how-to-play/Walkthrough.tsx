 ...
 *   - Welcome        = a play session exists (localStorage token + /api/s5/me ok)
...
import type { Locale } from "@/lib/s5/locale";
import {
...
import { readFtue, guestHasAnyScore } from "@/lib/s5/ftue";
...
/** The subset of the /api/s5/me payload this rail reads (junk-tolerant). */
type MeResp = {
  ok?: boolean;
  heldUsd?: number;
...
export function Walkthrough({ locale }: { locale: Locale }) {
  ...
  const dict: S5Dict = STRINGS[locale] ?? STRINGS.en;
  ...
  const steps: StepDef[] = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        cta: h.gs3Cta,
        href: "/s5/map",
        art: "/s5-art/kills/kill_k14-crater.webp",
        check: "held",
      },
      {
        key: "play",
        ...
        cta: h.gs4Cta,
        href: "/s5/play",
        art: "/s5-art/kills/kill_k10-impact.webp",
        check: "played",
      },
      {
        key: "raid",
        ...
        cta: h.gs5Cta,
        href: "/s5",
        art: "/s5-art/kills/kill_k02-cookoff.webp",
        check: "daily",
      },
      {
        key: "paid",
        ...
        cta: h.gs6Cta,
        href: "/s5/board",
        art: "/s5-art/kills/kill_k15-smouldering.webp",
        check: "qualified",
      },
    ];
  }, [h, dict]);

...
import { clampStats, readSessionToken } from "@/lib/s5/games";
import { resolveCommanderKey, type ResolvedTank } from "@/lib/s5/model";
import { defaultHqMe, type HqMe } from "./panels";
import { demoHqMe, isDemo } from "@/lib/s5/demo";
...
type MeResponse = {
   ...
   * signal /api/s5/me currently returns; holdings are a season total only. */

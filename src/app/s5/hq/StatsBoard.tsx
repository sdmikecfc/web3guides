...
import { tankByKey, type Tank } from "@/lib/s5/tanks";
import type { ResolvedTank } from "@/lib/s5/model";
    ...
    <section className="s5fr" aria-label={t.title}>
      ...
      {sprintNames ? (
        <div className="s5fr-sprint" role="status" aria-label={dict.sprint.aria} data-testid="fr-sprint">
          ...
          <Link href="/s5/map" className="s5fr-sprint-cta">
            {dict.sprint.frCta}
          </Link>
        </div>
      ) : null}
      ...
      {session ? (
        <div className="s5fr-warn" role="status" data-testid="fr-war-effort" style={{ borderColor: "#232a32" }}>
          ...
          <Link href="/s5/map" className="s5fr-warn-cta">
            {dict.warEffort.cta}
          </Link>
        </div>
      ) : null}

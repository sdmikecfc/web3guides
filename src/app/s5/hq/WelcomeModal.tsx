...
export function WelcomeModal({ dict, onClose }: { dict: S5Dict; onClose: () => void }) {
        ...
        <div className="s5w-body">
          ...
          <div className="s5w-actions">
            ...
            <button
              ...
              onClick={() => dismiss("welcome-enlist", "/s5/join")}
            >
...
.s5w-portrait {
  ...
  background:
    ...
    url("/s5-art/hq/camp-portrait.webp") 50% 30% / cover no-repeat #10141a;
}

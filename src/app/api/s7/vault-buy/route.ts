 ...
 * POST /api/s7/vault-buy  { t, item }
 *
 * MONEY PATH: it spends Shells, so it mirrors the proven /api/s7/tank-unlock
 * discipline EXACTLY:
 ...
 *     VAULT_ITEMS rotation (lib/s7/vault.ts) indexed by the UTC day number.
...
import { decalLabel } from "@/lib/s7/ftue";

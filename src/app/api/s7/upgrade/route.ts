 ...
 *
 *   POST /api/s7/upgrade  { t, stat }  ->  { ok, stats, shells, milestoneTank? }
 *
...
import { clampStats, statNextPrice, STAT_LABELS, type StatKey } from "@/lib/s7/games";
import { ownedTankKeys, STAT_MILESTONE_TANKS } from "@/lib/s7/model";

/**
 * Season 5, claim the FTUE "First Colors" decal. POST /api/s7/claim-ftue  { t }
 *
...
import { walletForSession, hqObject, heldUsdOf } from "@/lib/s7/me";
  ...
  for (let attempt = 0; attempt < 2; attempt++) {
    ...
    if (!player) {
      return NextResponse.json(
        { ok: false, error: "No commander for this wallet yet. Enlist at /s7/join first." },
        { status: 404 },
      );
    }

/**
 * Season 5, unlock ONE tank with Shells. POST /api/s6/tank-unlock  { t, tank }
 *
...
import { ownedTankKeys, resolveTank } from "@/lib/s6/model";
import { tankByKey, TANK_TIER_PRICES } from "@/lib/s6/tanks";
...
export async function POST(req: Request) {
  ...
  // fielding is /api/s6/hq's job; report ownership honestly instead of

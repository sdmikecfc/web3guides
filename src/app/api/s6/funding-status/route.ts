/**
 * Season 5, the funding-wizard STUCK-STEP DETECTOR. GET/POST /api/s6/funding-status
 *
 ...
 * same rule as /api/s6/me). GET is the tokenless probe: it returns NO_WALLET
...
export async function POST(req: Request) {
  ...
  try {
    wallet = await walletForSession(s6Db(), body.t);
  } catch {

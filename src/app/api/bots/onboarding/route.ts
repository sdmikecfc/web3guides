...
import { mutateOnboarding, onboardingView, type OnboardingMutation } from "@/app/bots/_server/onboarding";
...
export async function POST(req: Request) {
  try {
    const body = await readJson<OnboardingMutation & { t?: string }>(req);

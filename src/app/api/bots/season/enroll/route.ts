...
import { SeasonError, seasonErrorResponse, requireSeason, enrollSeason, parseSeasonEnroll } from "@/app/bots/_server/season";
...
export async function POST(req: Request) {
  try {
    ...
    return NextResponse.json(await enrollSeason(botsDb(), auth.wallet, input));

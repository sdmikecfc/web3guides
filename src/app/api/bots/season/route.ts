...
import { SeasonError, seasonErrorResponse, requireSeason, seasonState } from "@/app/bots/_server/season";
...
export async function GET(req: Request) {
  try {
    ...
    return NextResponse.json(await seasonState(botsDb(), auth.wallet));

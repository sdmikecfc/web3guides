/**
 * Season 5, unlock ONE tank with Shells. POST /api/s5/tank-unlock  { t, tank }
 *
...
import { ownedTankKeys, resolveTank } from "@/lib/s5/model";
import { tankByKey, TANK_TIER_PRICES } from "@/lib/s5/tanks";
...
export async function POST(req: Request) {
  ...
  // fielding is /api/s5/hq's job; report ownership honestly instead of

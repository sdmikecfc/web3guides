 ...
 *
 *   POST /api/s5/upgrade  { t, stat }  ->  { ok, stats, shells, milestoneTank? }
 *
...
import { clampStats, statNextPrice, STAT_LABELS, type StatKey } from "@/lib/s5/games";
import { ownedTankKeys, STAT_MILESTONE_TANKS } from "@/lib/s5/model";

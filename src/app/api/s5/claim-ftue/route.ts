/**
 * Season 5, claim the FTUE "First Colors" decal. POST /api/s5/claim-ftue  { t }
 *
...
import { walletForSession, hqObject, heldUsdOf } from "@/lib/s5/me";
  ...
  for (let attempt = 0; attempt < 2; attempt++) {
    ...
    if (!player) {
      return NextResponse.json(
        { ok: false, error: "No commander for this wallet yet. Enlist at /s5/join first." },
        { status: 404 },
      );
    }

"use client";
/**
 * CRYPT dev harness: class picker, level slider, gear tier selects, seed
...
import CryptClient from "../../s7/games/crypt/Client";
...
export default function DevClient() {
  ...
  const [seed, setSeed] = useState("dev-crypt-1");
      ...
      <div style={{ maxWidth: 880, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 10, alignItems: "center", marginBottom: 14, fontSize: 13 }}>
          ...
          <span style={{ color: "#87919b", fontSize: 12 }}>
            Side thirds turn, top-middle steps forward, bottom-middle steps back, Space swings. WASD and arrows work
            too. M toggles the minimap.
          </span>
        </div>

        <CryptClient key={runKey} loadout={loadout} seed={seed} onDone={(sc) => setLastScore(sc)} />
      </div>
    </main>
  );
}

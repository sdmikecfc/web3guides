"use client";
/**
 * HORDE dev harness: class picker, level slider, gear tier selects, seed
...
import HordeClient from "../../s7/games/horde/Client";
...
export default function DevClient() {
  ...
  const [seed, setSeed] = useState("dev-horde-1");
      ...
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 10, alignItems: "center", marginBottom: 14, fontSize: 13 }}>
          ...
          <span style={{ color: "#87919b", fontSize: 12 }}>
            Hold the pointer to walk and swing. Space burns mana on the class skill. Walk over drops to take them.
          </span>
        </div>

        <HordeClient key={runKey} loadout={loadout} seed={seed} onDone={(sc) => setLastScore(sc)} />
      </div>
    </main>
  );
}

...
export default function GameShell() {
  ...
  return <div className={css.shell}>
    ...
    {drawer && <GameDrawer title={drawer === "sample" ? "A workshop character" : drawer === "tools" ? "Your tool board" : drawer === "earn" ? "Feed your robot" : drawer === "campaign" ? "Model Kombat prizes" : drawer === "community" ? "Around the workshop" : drawer === "name" || drawer === "look" ? "A little personality" : "A helping hand"} onClose={() => { setDrawer(null); setResetAsk(false); }}>

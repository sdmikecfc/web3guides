...
import css from "./legacy-garage-room.module.css";
...
export default function LegacyGarageRoom({ builds, parts, selectedBay, rows, sample, lookFor, onSelect, onBuild, onName, onFight, onParts, onTools, onEarn, onProgress, onExplore, nudge, onDismiss, onRecycle, busy = false }: {

...
- Main Garage, Parts, Build and Fight navigation stays in one app shell. At this flame revision, full concept-art room presentation was still incomplete. The subsequent [room revision](../_game/ROOMS.md) restores full workshop, wooden shop, arena and street settings with verified desktop/mobile layouts. Combat Lab remains separate.

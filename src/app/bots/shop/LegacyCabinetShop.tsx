...
import css from "./legacy-cabinet.module.css";
...
export default function LegacyCabinetShop({ shipment, st, day, initialSlot, leftMs, tomorrow, returns, toast, onBuy, embedded = false, browseOnly }: Props) {

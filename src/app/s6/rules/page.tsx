...
import { DOMA_HELP } from "@/lib/s6/help";
...
import { EDUCATION } from "@/lib/s6/hq";
...
export const metadata = {
  ...
  description:
    "Every rule of the season on one page: the pool, Signal, Scrap, the hold tiers, and fair play.",
};
...
export default async function S5Rules() {
  ...
  const rewardArgs = {
    ...
    // per-mainframe figure is the whole point of the 2026-08-16 rewrite, so
  ...
  return (
    <PageShell>
      ...
      <p style={{ textAlign: "center", fontSize: 13, color: UI.faint, marginTop: 30 }}>
        ...
        {" · "}
        <Link href="/s6/join" style={{ color: UI.muted }}>{d.links.enlist}</Link>
        {" · "}

...
export const metadata = {
  ...
  description:
    "Every pilot on the front: where they camp, what they drive, and how their machine is tuned.",
};
...
export default async function S5ExplorePage() {
  ...
  return (
    <ExploreMap
      ...
      totalCommanders={snap.topPilots.length > bases.length ? snap.topPilots.length : bases.length}
    />
  );
}

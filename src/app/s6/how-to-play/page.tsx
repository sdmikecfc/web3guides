...
import { HELP_LINKS } from "@/lib/s6/help";
...
import { EDUCATION_BY_KEY, type EducationKey } from "@/lib/s6/hq";
import { DOMA_APP_URL } from "@/lib/s6/funding";
...
export const metadata = {
  ...
  description:
    "A free mech game played on real domains. Enlist in one signature, pick a mech, play the arcade, and hold a mainframe from $5 to earn Signal daily. Every mainframe pays its peak, and a liberation pays in full.",
};
  ...
  return (
    <PageShell>
      ...
      <Section id="manual" n={3} title={h.manualHeading}>
        ...
        <ManualSection id="money" title={h.s2Title} open>
          ...
          {/* THE WHOLE PURSE, IN ONE LINE. Since 2026-08-16 the pool IS the
              season's money: one pot, split into a slice per mainframe, with
              no second envelope to account for. The rows below say what a
              slice is and how it pays. The full catalog (Signal, Scrap, cash,
              trophies) lives on /s6/rules. */}
          <Panel style={{ borderColor: `${UI.good}33`, marginBottom: 12 }}>
            ...
            <p style={{ margin: "10px 0 0", fontSize: 13 }}>
              <Link href="/s6/rules#rewards" style={{ color: UI.steel }}>
            ...
            {[
              {
                ...
                cost: h.costFree,
                costColor: UI.good,
                action: { label: d.links.enlist, href: "/s6/join" },
              },
              {
                n: 2,
                title: h.step2Title,
                ...
                cost: h.costFree,
                costColor: UI.good,
                action: { label: d.links.hq, href: "/s6" },
              },
              {
                n: 3,
                title: h.step3Title,
              ...
              },
              {
                ...
                cost: h.costFree,
                costColor: UI.good,
                action: { label: d.links.play, href: "/s6/play" },
              },
              {
                n: 5,
                title: h.step5Title,
                ...
                costColor: UI.ember,
                note: h.step5Note,
                action: { label: d.links.map, href: "/s6" },
              },
            ].map((s) => (
        ...
        {/* 3.5 Your HQ. s5Title/s5Body, NOT s6* (copy audit 2026-08-17): this
        ...
        <ManualSection id="hq" title={h.s5Title}>
          <div style={{ marginBottom: 14 }}>
            <ArtBand src="/s6-art/hq/hangar.webp" alt="" height={170} />
          </div>
          <Body>{h.s5Body}</Body>
          <div
            style={{
          ...
          >
            <Card
              title={h.s6TankTitle}
              body={fill(h.s6TankBody, { tanks: tankCount })}
              accent={UI.ember}
            />
            <Card title={h.s6CmdTitle} body={h.s6CmdBody} accent={UI.steel} />
          </div>
          ...
          >
            <Card title={h.s6CamoTitle} body={h.s6CamoBody} />
            <Card title={h.s6TrophyTitle} body={h.s6TrophyBody} />
            <Card title={h.s6GarageTitle} body={h.s6GarageBody} />
          </div>
        </ManualSection>
      ...
      >
        ...
        >
          <Link href="/s6" style={{ color: UI.steel, fontSize: 13.5, textDecoration: "none" }}>
            {h.ctaSecondary}
          </Link>
          <Link href="/s6/rules" style={{ color: UI.steel, fontSize: 13.5, textDecoration: "none" }}>
            {h.ctaTertiary}
          </Link>
        </div>
      ...
      <p style={{ textAlign: "center", fontSize: 13, color: UI.faint, marginTop: 26 }}>
        ...
        {" · "}
        <Link href="/s6/board" style={{ color: UI.muted }}>
          {d.links.board}
        </Link>
      </p>

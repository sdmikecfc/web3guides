"use client";
/**
 * S6 RAID ODDS STRIP: the shill layer. One line of truth from /api/s6/raid
 * (which boss rolls at 14:00 UTC, how many pilots are on the roster, the
 * ESTIMATED odds) plus the CALL FOR REINFORCEMENTS tweet-intent button. An
 * empty roster adds the enlist CTA instead of hiding.
 *
 * The strip line comes from the s6 dict (en/ko/zh, cookie locale); the tweet
 * body + intent URL stay in lib/s6/raid.ts and stay ENGLISH on purpose (a
...
import { tweetIntentUrl, resultIntentUrl, type RaidBoss } from "@/lib/s6/raid";

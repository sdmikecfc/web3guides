...
export const metadata = {
  title: "Your Base | Launch Wars S6: Uprising",
  description:
    "Your mech, your pilot, your kit. Hold a featured mainframe from $5, earn Signal daily, and liberate with The Iron Column.",
};

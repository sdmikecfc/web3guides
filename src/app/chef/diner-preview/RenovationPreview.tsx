...
export const STAGE_COPY:Record<RestaurantStage,{name:string;description:string;included:string}>={
  ...
  diner:{name:'Your first diner',description:'A worn-wood diner with your own stools, a wall booth and some local character. Servers take orders and earn tips.',included:'12 × 10 · keep your stools · booth for two · wood floor, clock, bear, trophy & pie display · 3 bathroom bays'},
  restaurant:{name:'Your full restaurant',description:'An enclosed kitchen and a dining room with linen-covered tables, flowers and proper place settings. Servers collect food inside the kitchen.',included:'14 × 12 · 3 dressed tables & 6 chairs · terrazzo & art deco finishes · chandelier, wine rack, mirror & palm · 4 bathroom bays'},
};

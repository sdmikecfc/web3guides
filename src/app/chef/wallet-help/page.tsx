...
export default function WalletHelpPage() {
  return <main className={css.page}><article className={`${css.card} ${css.helpCard}`}>
    ...
    <section className={css.helpSection}><h2>Playing on your phone</h2>
      <ol><li>Open Domain Kitchen in your wallet&apos;s built-in browser.</li><li>Tap <strong>Connect wallet</strong> and approve the connection in the wallet.</li><li>Tap <strong>Play beta</strong>. Stay in that browser to play.</li></ol>
    ...
    <section className={css.helpSection}><h2>Playing on your computer</h2><p>Use a browser with your wallet extension installed and unlocked, then choose <strong>Connect wallet</strong>. If you have just installed it, reload the game.</p></section>

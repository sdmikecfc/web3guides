/**
 * S7 shared SAMPLE LOADER — the audio equivalent of art.ts's try-image-else-
 * vector contract: TRY SAMPLE, ELSE SYNTH. Lazily fetches + decodes audio
 * files from /s7-art/audio/<name>.<ext> into an AudioBuffer cache, keyed by
 ...
 * correctness one: serving /s7-art/audio/<name>.mp3 makes download-manager
 ...
 * and it collapses 35 requests into 1. Built by gen-s7-audio.py; the mp3/wav
 * intermediates live in audio_build/ and are NOT served. */
const PACK_URL = "/s7-art/audio/pack.json";

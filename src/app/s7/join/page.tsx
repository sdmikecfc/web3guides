/**
 * Season 5 /s7/join, the WALLET-FIRST enlist page (the proven S4 /s4/join
 * flow ported onto the s7 tables, one team). Server shell + client JoinForm.
 */
...
export default function S7JoinPage() {
    ...
    <PageShell>
      <div style={{ width: "100%", maxWidth: 460, margin: "0 auto" }}>
        ...
        <p style={{ textAlign: "center", marginTop: 26, fontSize: 13 }}>
          ...
          <Link href="/s7/how-to-play" style={{ color: UI.muted }}>
            {d.links.howToPlay}
          </Link>
        </p>
      </div>

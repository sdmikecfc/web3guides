/**
 * Launch Wars Season 7, /s7 OpenGraph image (mirrors the S4 approach):
...
export const alt = "Launch Wars Season 7: Realmfall";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <img
          src={`${base}/s7-art/front/wash.webp`}
          alt=""
          width={1200}
          height={630}
        ...
        <div style={{ display: "flex", flexDirection: "column", padding: "0 64px 48px", position: "relative" }}>
          <div style={{ display: "flex", fontSize: 24, letterSpacing: 8, color: "#ffd28a", marginBottom: 6 }}>
            LAUNCH WARS S7 · REALMFALL vs THE LICH
          </div>
          ...
          <div style={{ display: "flex", fontSize: 32, color: "#8fe2ff", marginBottom: 18 }}>
            {snap.empty
              ? "The war for the realm begins soon"

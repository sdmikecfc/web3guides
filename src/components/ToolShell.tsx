      ...
      <header style={{
        ...
        <div style={{
          ...
          <nav style={{ display: "flex", alignItems: "center", gap: 20 }}>
            ...
            <a href="/tools/security-score" style={{ fontFamily: "system-ui", fontSize: "0.82rem", color: "#64748b", textDecoration: "none", transition: "color 0.2s" }}
               onMouseOver={e => (e.currentTarget.style.color = "#e2e8f0")}
               onMouseOut={e => (e.currentTarget.style.color = "#64748b")}>
              Security Scorer
            </a>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 20 }}>
            {[
              ...
              { label: "Security Scorer", href: "/tools/security-score" },

/**
 * S7 IN-APP BUY: the Doma Launchpad bonding curve, called directly.
 *
 ...
 * enlist, so a keep is one tap away and they never leave the game.
 *
 ...
 * graduates, liquidity migrates to a Uniswap V3 pool. Every keep we

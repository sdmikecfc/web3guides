...
const weaponStyle=(kind:WeaponKindV6):StyleV6=>["hammer","shotgun_wide","shoulder_cannon"].includes(kind)?"tank":["sword","paired_blades","shock_blade","flame_sword"].includes(kind)?"speed":"ranged";

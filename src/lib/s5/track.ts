/**
 * S5 funnel tracking, client-safe beacon helper.
 *
 * Fire-and-forget: posts { session_id, event, ref, utm, path } to
 * /api/s5/events via navigator.sendBeacon (fetch keepalive fallback). The
 * anonymous session id is a uuid persisted in localStorage "s5_sid"; no wallet
...
const INVITE_DAY_KEY = "s5_ic_day"; // invite_clicked dedupe, mirrors landing_view

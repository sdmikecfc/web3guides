/**
 * S6 PUBLIC GARAGE handles, pure client-safe logic (no IO, no secrets, no
 * imports). A handle is what appears after /s6/hq/ in a public garage URL:
 *
 ...
 * card rendering): blank or non-string becomes "Pilot", a raw wallet

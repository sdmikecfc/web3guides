/**
 * S6 FTUE quest chain, client-safe helpers.
 *
 * The footlocker panel is a 5-quest log that walks a new pilot from first
 * tap to first hold. Quests 1 and 2 are PRE-WALLET and tracked in localStorage
 * under "s6_ftue" (merged visually with the server truth once a session
...
export const FTUE_STORAGE_KEY = "s6_ftue";
...
/** 1 bond XP per 100 Signal (display math only; the bot owns the tier). */

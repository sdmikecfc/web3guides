/**
 * S6 IN-APP BUY: the Doma Launchpad bonding curve, called directly.
 *
 ...
 * enlist, so a mainframe is one tap away and they never leave the game.
 *
 ...
 * graduates, liquidity migrates to a Uniswap V3 pool. Every mainframe we

...
const tests = ['bots-v6-roster-check.ts','bots-v6-check.ts', 'bots-v6-balance-check.ts', 'bots-v6-pose-check.ts', 'bots-v6-body-check.ts', 'bots-v6-combat-regression-check.ts', 'bots-v6-carry-check.ts', 'bots-v6-balance-matrix.ts', 'bots-v6-balance-grid.ts', 'bots-v6-pressure-grid.ts', 'bots-v6-hero-balance-check.ts'];

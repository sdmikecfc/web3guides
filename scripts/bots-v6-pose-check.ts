...
import { BODY_SOCKETS_V6,add,createFightV6,dotV6,fighterPoseV6,footprintSupportV6,fromVectorsQuatV6,length3,multiplyQuatV6,presetV6,restArmPoseV6,rotateQuatV6,sampleWeaponPathV6,scale,solveArmPoseV6,subtract,sweepMovingCapsuleV6,sweepRobotV6,weaponGripPoseV6,type QuatV6,type Vec3 } from "../src/lib/bots/v6";

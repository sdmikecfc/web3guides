...
import { createFightV4, preset, runFightV4, SLOTS, type EventV4 } from "../src/app/bots/lab/engine";
const folder = "public/bots-art/3d/clay-lab/";
...
async function main() {
  ...
  const replay60 = replay(1); a.bones.elbowL.rotation.x = .7; a.bones.elbowR.rotation.x = -1;
